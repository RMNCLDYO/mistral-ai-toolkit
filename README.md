...
|-----------------	|----------	|------------------------	|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
| `api_key`       	| _str_    	| null                   	| Required for authenticating API requests. Your unique API key can be obtained from your Mistral account.                                                                                                                                                                                                                 	|
| `model`         	| _str_    	| `mistral-large-latest` 	| ID of the model to use.                                                                                                                                                                                                                                                                                                  	|
| `system_prompt` 	| _str_    	| null                   	| The initial system prompt. The system prompt explicitly sets the instructions for the model.                                                                                                                                                                                                                             	|
...
| `max_tokens`    	| _int_    	| null                   	| The maximum number of tokens to generate in the completion. The token count of your prompt plus `max_tokens` cannot exceed the model's context length.                                                                                                                                                                   	|
| `random_seed`   	| _int_    	| null                   	| The seed to use for random sampling. If set, different calls will generate deterministic results.                                                                                                                                                                                                                        	|
